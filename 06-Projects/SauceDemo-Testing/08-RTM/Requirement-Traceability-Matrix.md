...
| SD-006 | Products should be displayed correctly after login. | TC-009, TC-010, TC-011, TC-012, TC-013, TC-014 | Pass |
| SD-007 | Products should be sortable by name and price. | TC-015, TC-016, TC-017, TC-018 | Pass |
| SD-008 | Users should be able to manage shopping cart items. | TC-019, TC-020, TC-021, TC-022, TC-023, TC-024 | Pass |
